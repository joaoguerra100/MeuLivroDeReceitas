...
public class ChangePasswordUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        var passwordEncripter = PasswordEncriptorBuilder.Build();
    ...
    public async Task Error_NewPassword_Empty()
    {
        ...
        await act.Should().ThrowAsync<ErrorOnValidationException>()
            .Where(e => e.ErrorMessages.Count == 1 && e.ErrorMessages.Contains(ResourceMessagesException.GetMessage("PASSWORD_EMPTY")));
    ...
    [Fact]
    public async Task Error_CurrentPassword_Differente()
    {
        (var user, var password) = UserBuilder.Build();
        ...
        await act.Should().ThrowAsync<ErrorOnValidationException>()
            .Where(e => e.ErrorMessages.Count == 1 && e.ErrorMessages.Contains(ResourceMessagesException.GetMessage("PASSWORD_dIFFERENT_CURRENT_PASSWORD")));
