...
public class GenerateRecipeValidatorTest
{
    ...
    public void Error_More_Maximum_Ingredient()
    {
        ...
        result.Errors.Should().ContainSingle().And.Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.GetMessage("INVALID_NUMBER_INGREDIENTS")));
    }
    ...
    public void Error_Duplicated_Ingredient()
    {
        ...
        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle().And.Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.GetMessage("DUPLICATED_INGREDIENTS_IN_LIST")));
    }
    ...
    public void Error_Ingredient_Not_Following_Pattern()
    {
        ...
        var request = RequestGenerateRecipeJsonBuilder.Build(count: 4);
        request.Ingredients.Add("This is an invalid ingrendient because is too long");

        var result = validator.Validate(request);

        result.IsValid.Should().BeFalse();
        result.Errors.Should().ContainSingle().And.Contain(e => e.ErrorMessage.Equals(ResourceMessagesException.GetMessage("INGREDIENT_NOT_FOLLOWING_PATTERN")));
    }
}
