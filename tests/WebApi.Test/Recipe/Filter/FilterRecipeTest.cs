...
{
    private const string METHOD = "recie/filter";
    ...
    public FilterRecipeTest(CustomWebApplicationFactory factory) : base(factory)
    {
        ...
        _recipeCookingTime = factory.GetRecipeCookingTipe();
    ...
    public async Task Success()
    {
        var request = new RequestFilterRecipeJson
        {
            ...
            Difficulty = [(MyRecipeBook.Communication.Enums.Difficulty)_recipeDifficultyLevel],
            DishType = _recipeDishTypes.Select(dishType => (MyRecipeBook.Communication.Enums.DishType)dishType).ToList(),
